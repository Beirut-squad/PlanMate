...
class GetTaskByTaskStateIdAndProjectIdTest {
    ...
    fun `getTaskByStateIdAndProjectId should return tasks when repository returns tasks`() = runTest {
        ...
        val task1 = createTaskHelper(projectId = projectId, taskState = createStateHelper(id = stateId))
        val task2 = createTaskHelper(projectId = projectId, taskState = createStateHelper(id = stateId))
