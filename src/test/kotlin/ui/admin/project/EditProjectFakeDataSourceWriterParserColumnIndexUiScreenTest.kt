...
class EditProjectFakeDataSourceWriterParserColumnIndexUiScreenTest {
    @MockK
    ...
    fun `show should display menu and process user input until exit option is selected`() {
        ...
        every { printer.printOptions("1- Edit project name") } just runs
        every { printer.printOptions("2- Edit project description") } just runs
        every { printer.printOptions("0- Return") } just runs
        every { printer.printTitle("Choose what you want to change in project.") } just runs
        every { printer.printPlainText("Edit Project Name: ", withNewLine = false) } just runs
        every { printer.printPlainText("Edit Project Description: ", withNewLine = false) } just runs
        ...
        verify(exactly = 3) { printer.printTitle("Choose what you want to change in project.") }
        verify(exactly = 3) { printer.printOptions("1- Edit project name") }
        verify(exactly = 3) { printer.printOptions("2- Edit project description") }
        verify(exactly = 3) { printer.printOptions("0- Return") }
        ...
        verify(exactly = 1) { printer.printPlainText("Edit Project Name: ", withNewLine = false) }
        verify(exactly = 1) { printer.printPlainText("Edit Project Description: ", withNewLine = false) }
    ...
    fun `editProjectName should update project name when user is logged in`() {
        ...
        // Then
        verify { printer.printPlainText("Edit Project Name: ", withNewLine = false) }
    ...
    fun `editProjectDescription should update project description when user is logged in`() {
        ...
        // Assert
        verify { printer.printPlainText("Edit Project Description: ", withNewLine = false) }
    ...
    fun `displayMenu should show all menu options in correct order`() {
        ...
        // Assert
        verifyOrder {
            printer.printOptions("1- Edit project name")
            printer.printOptions("2- Edit project description")
            printer.printOptions("0- Return")
