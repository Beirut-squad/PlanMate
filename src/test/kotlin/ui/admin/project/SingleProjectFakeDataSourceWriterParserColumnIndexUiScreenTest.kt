...
class SingleProjectFakeDataSourceWriterParserColumnIndexUiScreenTest {
    ...
    fun setUp() {
        ...
        singleProjectScreen = SingleProjectScreen(printer, reader, deleteProjectUseCase, getCurrentLoggedInUserUseCase,editProjectScreen)
    }
    ...
    fun `should show the title when showed`() {
        ...
        // Then
        verify(exactly = 1) { printer.printTitle("Project Test Project") }
    }
    ...
    fun `should ask the user what they want to do when showed`() {
        ...
        // Then
        verify(exactly = 1) { printer.printInfoLine("What would you like to do?") }
    }
    ...
    fun `should display the options to user when showed`() {
        ...
        // Then
        verify(exactly = 1) { printer.printOptions("Edit project", "Delete project", "View project states") }
    }
    ...
    fun `should ask for user input after displaying titles and options`() {
        ...
        // Then
        verifyOrder {
            printer.printTitle("Project Test Project")
            printer.printInfoLine("What would you like to do?")
            printer.printOptions("Edit project", "Delete project", "View project states")
            reader.readInt()
        }
    }
