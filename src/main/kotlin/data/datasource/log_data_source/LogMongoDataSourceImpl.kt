...
class LogMongoDataSourceImpl(
    ...
    override suspend fun saveProjectLog(projectLog: ProjectLog) {withContext(Dispatchers.IO) {
        mongoConnection.projectLogs.insertOne(projectLog.toDocument())
    }}

    override suspend fun saveTaskLog(taskLog: TaskLog){ withContext(Dispatchers.IO) {
